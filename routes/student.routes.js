module.exports = app => {
    ...
    // http://localhost:8075/api/studentms2/getstudents
    ...
    //route to get students with fees balances
    router.get("/studentswithbalances", student_controller.getStudentsWithBalances);
